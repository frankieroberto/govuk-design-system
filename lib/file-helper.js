...
exports.getMacroOptions = componentName => {
  ...
  for (let option of options) {
    ...
    if (option.isComponent) {
      ...
      if (option.name === 'hint' || option.name === 'label') {
        ...
        if (otherComponentOptions) {
          ...
          option.description += option.description += ` See [${option.name}](#nunjucks-macro-options-${option.name}).`
        }
      // Otherwise just link to that component
        ...
        option.description += ` See [${option.name}](${otherComponentPath}#nunjucks-macro-options).`
      }
    }
    ...
    if (option.params) {
      ...
      option.description += ` See [${option.name}](#nunjucks-macro-options-${option.name}).`
    }
